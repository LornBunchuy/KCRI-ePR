...
$(document).ready(function () {
    ...
    objFunChange.btnChange.click(function () {
        ...
        getJsonString("Auth", "AuthChangePassword", ChangeData, (response) => {
            if (response == 200) {
                XSAlert({
                    title: 'Success',
...
function clearChange() {
    objFunChange.txtUsername.val('');
    objFunChange.txtPassword.val('');
    objFunChange.txtNewPassword.val('');
    objFunChange.txtConfirmPassword.val('');
}
